...
@section('title', 'Beangasm | Reviews')
@section('content')
  ...
  <div class="container py-3">
		<div class="row">
			...
			<div class="col-12 col-lg-3 pr-lg-0 mb-2">
				...
				<div class="row mx-0 white mb-2">
					...
					<ul class="list-unstyled mb-0">
						...
						<li><a href="{{ route('store-reviews') }}" class="p-3 d-flex align-items-center dsb-menu-link active"><img class="of-cover mr-3 nav-img" src="{{url('assets/frontend/img/doc.svg')}}" width="20" height="20" /> Vendor Review</a></li>
			...
			<div class="col-12 col-lg-9 mb-2">
                ...
                <h6 class="dsb-title-content d-inline-block">Reviews</h6>
							</div>
            </div>
                      ...
                      <tr>
                        ...
                        <td>COFFEACIRCULOR</td>
                        <td>
                          <a href="/" class="d-inline-block py-1 px-2 primary text-white btn mb-2 dsb-crd-1-ket">Detail</a>
                        </td>
                      </tr>
