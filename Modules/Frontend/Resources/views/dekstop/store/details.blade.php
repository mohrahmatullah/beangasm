...
<main>
        ...
        <div class="col-12">
          <nav aria-label="breadcrumb ">
            <ol class="breadcrumb mb-0 white px-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">{{ $store->display_name }}</li>
            </ol>
          </nav>
        </div>
      </div>
  ...
  <!-- #DESKTOP# -->
  <section class="d-flex d-none store-ls-s d-flex align-items-center py-2 wow fadeIn" data-wow-delay=".7s">
    <div class="container">
      <div class="row">
        <div class="col-12">
          <div class="row">
            ...
            <div class="col-12 col-md-4 col-lg-3">
              ...
              <a class="hm-fp-c pb-lg-3 mb-4 s d-flex align-items-center flex-lg-column flex-row">
                ...
                <div class="hm-fp-bdy w-100 px-3">
                  <h5 class="mb-2" style="min-height: 50px;max-height: 50px;">{{ $store->display_name }}</h5>
